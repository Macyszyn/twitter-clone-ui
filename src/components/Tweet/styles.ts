...
export const Container = styled.div`
    ...
    border-bottom: 1px solid var(--outline); /*linha no final da div*/
    max-width: 100%;
`;
...
export const Header = styled.div`
    ...
    > strong, span {
        white-space: nowrap;
        /* quando texto não couber na tela, mostra parte dele e acrecenta ..overflow. no final */
...
export const Status = styled.div`
    ...
    /* primeiro elemento da div Status */
    &:nth-child(1){
        &, > svg path {
            color: var(--gray);
        }
